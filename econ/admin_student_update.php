        ...
        while ($value = mysqli_fetch_array($sql1, MYSQLI_ASSOC)) {
            ...
            ?>
                                                    <tr>
                                                        ...
                                                        <td> <a class="btn btn green" href="admin_edit.php?PRN=<?php echo $value['PRN']; ?>">Edit Info </a>
                                                             </td>
                                                             <td>
                                                              <?php if ($value['status'] == "1") {?>
                                             <a class="btn btn red" href="admin_suspend.php?PRN=<?php echo $value['PRN']; ?>">Suspend</a>

                                        <?php } elseif ($value['status'] == "0") {?>
                                       <a class="btn btn crown" href="admin_suspend.php?PRN=<?php echo $value['PRN']; ?>">Suspended</a>
